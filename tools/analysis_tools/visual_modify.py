        ...
        if sensor_modality in ['lidar', 'radar']:
            ...
            if with_anns:
                ...
                for box in boxes_gt:
                    ...
                    render_2d(box.corners(), ax[j + 2, ind], view=camera_intrinsic, normalize=True, colors=(c, c, c))
...
if __name__ == '__main__':
    ...
    # bevformer_results = mmcv.load('test/bevformer_base/Sun_Dec_10_02_50_07_2023/pts_bbox/results_nusc.json')
    sample_token_list = list(bevformer_results['results'].keys())
    out_foler = "outputs"
    for id in range(0, 2):
        render_sample_data(sample_token_list[id], pred_data=bevformer_results, out_path= os.path.join(out_foler, sample_token_list[id]))
